...
CFLAGS = -fno-pic -static -fno-builtin -fno-strict-aliasing -O2 -Wall -Wno-stringop-overflow -MD -ggdb -m32 -Werror -fno-omit-frame-pointer
...
clean: 
	...
	*.o user/*.o user/*.d user/*.asm *.d *.asm *.sym vectors.S bootblock entryother \
